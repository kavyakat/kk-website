...
export const summaryText = `Senior AI Data Engineer and Full-Stack Developer with 10+ years of experience across the SAP ecosystem, specializing in data analytics, AI-driven insights, SAP HANA Cloud, SAP Analytics Cloud, SAP BTP, and Cloud Application Programming (CAP). Strong background in building large-scale analytical solutions, backend services, high-performance data pipelines, and internal developer tools for SAP Commerce Cloud. Known for strong ownership, clean engineering, cross-functional collaboration, and delivering data products that drive business and technical decision-making.`;

export const contactLinks = {
  email: "mail@kavyakat.de",
